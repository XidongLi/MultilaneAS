...
updater.policy = solve(MCTSSolver(n_iterations=50, depth=20, exploration_constant=5.0), UnderlyingMDP(pomdp))
updater.nb_sims = 1
...
snapshot = AutomotiveVisualization.render([roadway, scene, idoverlay], camera=camera)
