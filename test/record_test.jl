...
dmodel = MultilaneAS.NoCrashIDMMOBILModel(pp, behaviors)
...
updater.policy = MultilaneAS.Record(pomdp)
updater.nb_sims = 2
...
calback = (MultilaneAS.MLcollision_check(), MultilaneAS.ReachGoalCallback(), MultilaneAS.BeliefUpdate(), MultilaneAS.RecordCallback())
