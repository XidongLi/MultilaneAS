...
using Logging
#io = open("C:/Users/Mers/Desktop/record.txt","a")  #path
...
scene = Scene([                     #根据roadway的宽度给出各个车的y值 ， 并确定初速度
    ...
    Entity(VehicleState(VecSE2(60.0,3.0,0.0), roadway, 31.0), VehicleDef(), 9),
    Entity(VehicleState(VecSE2(60.0,6.0,0.0), roadway, 31.0), VehicleDef(), 10)
])
=#
